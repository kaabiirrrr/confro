...
const FreelancerVerificationPage = () => {
    ...
    const loadRequests = async () => {
        try {
            setLoading(true);
            const response = await getAdminVerifications('freelancer', statusFilter);
            setRequests(response.data || []);
        } catch (error) {
            toast.error('Failed to load freelancer verification requests');
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="flex flex-col gap-3 sm:gap-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div>
                        ...
                        <p className="text-white/60 text-xs sm:text-sm mt-1">Review OCR-extracted data and approve freelancer identity documents</p>
                    </div>
                        ...
                        {loading ? (
                            ...
                            <tr><td colSpan="5" className="px-6 py-16 text-center text-white/40">
                                <div className="flex flex-col items-center gap-2">
                                    ...
                                    <p>No freelancer verifications found.</p>
                                </div>
                            </td></tr>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h2 className="text-xl font-bold text-white mb-1">
                                        Review Freelancer: {selectedRequest.profile?.name || selectedRequest.user?.email}
                                    </h2>
