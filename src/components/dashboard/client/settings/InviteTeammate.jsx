      ...
      <div className="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8 mt-2 pb-12 space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <div className="mb-6">
          ...
          <div className="relative group">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-accent/0 via-accent/20 to-accent/0 rounded-full blur opacity-0 group-focus-within:opacity-100 transition duration-500"></div>
        ...
        <div className="mb-6">
          <div className="flex flex-wrap justify-between items-start gap-3 mb-4">
            ...
            <Link
              ...
              className="bg-white/5 border border-white/10 text-white hover:bg-white/10 px-6 py-2 rounded-full text-sm font-bold transition-all shrink-0"
            >
              Upgrade
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <button
              ...
              className={`relative border rounded-[2rem] p-6 text-left transition-all duration-300 ${role === "messenger"
            ...
            <button
              ...
              className={`relative border rounded-[2rem] p-6 text-left transition-all duration-300 ${role === "recruiter"
                ? "border-accent bg-accent/5 shadow-[0_0_20px_rgba(77,199,255,0.05)]"
                : "border-white/5 bg-primary/40 hover:bg-white/5 hover:border-white/10"
                }`}
            >
            ...
            <button
              ...
              className={`relative border rounded-[2rem] p-6 text-left transition-all duration-300 ${role === "manager"
                ? "border-accent bg-accent/5 shadow-[0_0_20px_rgba(77,199,255,0.05)]"
                : "border-white/5 bg-primary/40 hover:bg-white/5 hover:border-white/10"
                }`}
            >
        ...
        {/* ACTION BUTTONS */}
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-3 border-t border-white/5 pt-8 mt-6">
          ...
          <button
            ...
            className={`w-full sm:w-auto px-8 py-3.5 rounded-full text-sm font-bold transition-all flex items-center justify-center gap-2 shadow-lg shadow-accent/20 ${inviteStatus === "sent"
