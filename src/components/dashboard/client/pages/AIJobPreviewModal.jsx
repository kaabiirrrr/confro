...
const AIJobPreviewModal = ({
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center px-4">
            ...
            {/* Modal Container */}
            <div className="relative w-full max-w-3xl bg-secondary border border-border rounded-[40px] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300">
                {/* AI Glow Effect */}
                <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-accent/5 rounded-full blur-[100px] -mr-48 -mt-48 pointer-events-none" />

                {/* Header */}
                <div className="relative p-6 pb-4 flex flex-col items-center justify-center text-center">
                ...
                <div className="relative px-10 pb-10 max-h-[75vh] overflow-y-auto custom-scrollbar">
                            ...
                            <div className="space-y-6">
                                <div className="grid grid-cols-1 gap-8">
                                    ...
                                    <div className="space-y-12">
                                        ...
                                        <div className="p-12 border border-accent/20 rounded-[44px] text-base text-light-text leading-relaxed font-medium whitespace-pre-wrap shadow-sm">
                                            {aiData.description}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                                    {aiData.skills.map(skill => (
                                        <button
                                            ...
                                            className={`flex items-center justify-between p-4 rounded-xl border transition-all ${selectedSkills.includes(skill)
