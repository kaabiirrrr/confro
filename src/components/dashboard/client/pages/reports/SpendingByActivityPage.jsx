      ...
      <div className="flex flex-wrap items-end gap-5 mb-10 p-6 bg-transparent border border-white/10 rounded-2xl">
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="bg-transparent border border-white/10 text-white text-sm rounded-lg px-4 py-2.5 focus:outline-none focus:border-accent/50 transition-all font-medium"
          />
        </div>
        <div className="space-y-1.5">
            ...
            {byContract.length > 0 && (
              <div className="bg-transparent border border-white/10 rounded-2xl overflow-hidden self-stretch flex flex-col">
                ...
                <div className="flex-1 overflow-auto">
                  <div className="grid grid-cols-[1fr_80px_100px_80px] gap-4 px-8 py-4 border-b border-white/10 text-[9px] text-white/20 font-black uppercase tracking-widest sticky top-0 bg-primary/95 backdrop-blur-md">
                  ...
                  {byContract.map((c, i) => (
                    <div key={c.contract_id ?? i} className="grid grid-cols-[1fr_80px_100px_80px] gap-4 px-8 py-5 border-b border-white/5 last:border-0 hover:bg-white/5 transition-all items-center group">
                      <div className="min-w-0 pr-4">
                        <span className="text-white text-xs font-bold truncate block group-hover:text-accent transition-colors">{c.title || `Contract #${c.contract_id}`}</span>
                      ...
                      <div className="text-right">
                        ...
                        <span className="text-[8px] text-accent/30 font-black lowercase block mt-0.5">usd</span>
                      </div>
                      <div className="text-right">
