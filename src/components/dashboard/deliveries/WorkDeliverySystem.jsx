        ...
        <div className="space-y-10">
            ...
            <div className="space-y-6">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 px-1">
                    <h2 className="text-xl font-bold text-white tracking-tight">Project Deliveries</h2>
                    
                    {/* Role Tabs for Client */}
                    {isClient && memberIds.length > 1 && (
                        <div className="flex bg-white/5 p-1 rounded-xl overflow-x-auto scrollbar-hide shrink-0">
                            <button 
