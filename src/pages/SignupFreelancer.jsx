      ...
      >
          <>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 sm:space-y-6">
              ...
              <div>
                <label className="block text-[13px] sm:text-[14px] font-medium mb-1 sm:mb-2 text-white/90">Email address</label>
                <input
                  {...register("email")}
              ...
              <div className="space-y-2 sm:space-y-4 pt-1 sm:pt-2">
                <label className="flex items-start gap-2 sm:gap-3 cursor-pointer">
                  ...
                  <span className="text-[12px] sm:text-[14px] text-text-secondary leading-tight sm:leading-snug">Send me helpful emails to find rewarding work and job leads.</span>
                </label>
                <label className="flex items-start gap-2 sm:gap-3 cursor-pointer">
