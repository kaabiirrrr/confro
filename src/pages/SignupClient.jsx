      ...
      >
          ...
          <>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 sm:space-y-6 flex flex-col flex-grow">
              ...
              <div>
                <label className="block text-[13px] sm:text-[14px] font-medium mb-1.5 sm:mb-2 text-white/90">Work email address</label>
                <input
                  {...register("email")}
              ...
              <div className="space-y-3 sm:space-y-4 pt-2 sm:pt-2">
                <label className="flex items-start gap-3 sm:gap-3 cursor-pointer">
                  ...
                  <span className="text-[13px] sm:text-[14px] text-text-secondary leading-tight sm:leading-snug">Send me emails with tips on how to find talent that fits my needs.</span>
                </label>
