    ...
    >
      ...
      <header className="flex-shrink-0 w-full bg-primary">
        <div className="max-w-[1630px] mx-auto h-12 md:h-20 px-4 md:px-8 flex items-center justify-between">
          ...
          <div className="text-[13px] md:text-[16px] text-light-text/80">
            Looking for work?{" "}
            <Link to="/signup-freelancer" className="text-accent font-medium">Apply as talent</Link>
          </div>
        </div>
      </header>
      ...
      <div className="flex-1 overflow-y-auto pb-24 md:pb-0">
        ...
        >
          ...
          <form id="signup-client-form" onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-2.5 md:space-y-5">
              ...
              {/* Email */}
              <div>
                <label className="block text-[12px] md:text-[14px] font-medium mb-1 md:mb-2 text-white/90">Work email address</label>
                <input
                  {...register("email")}
              ...
              <div className="space-y-1.5 md:space-y-3">
                <label className="flex items-start gap-2.5 cursor-pointer">
                  ...
                  <span className="text-[11px] md:text-[14px] text-text-secondary leading-snug">Send me emails with tips on how to find talent that fits my needs.</span>
                </label>
                <label className="flex items-start gap-2.5 cursor-pointer">
                  ...
                  <span className="text-[11px] md:text-[14px] text-text-secondary leading-snug">
                    ...
                    <Link to="/legal#terms" className="text-accent hover:underline">User Agreement</Link> and{" "}
