      ...
      >
          ...
          <>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                <label className="block text-[14px] font-medium mb-2 text-white/90">Work email address</label>
                <input
                  {...register("email")}
              ...
              <div className="space-y-4 pt-2">
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-[14px] text-text-secondary leading-snug">Send me emails with tips on how to find talent that fits my needs.</span>
                </label>
